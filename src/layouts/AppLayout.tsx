...
import {
  ...
  BarChart2, Download, Users, Truck, BookOpen, BookCopy,
...
const NAV = [
  ...
  { to: PATHS.RETURNS,    label: 'Returns',        icon: <RotateCcw       size={17} strokeWidth={1.8}/> },

  { section: 'INVENTORY' },
  { to: PATHS.PRODUCTS,   label: 'Products',       icon: <Package         size={17} strokeWidth={1.8}/>, alertKey: 'lowStock' },
  { to: PATHS.STOCK,      label: 'Stock Report',   icon: <BarChart2       size={17} strokeWidth={1.8}/> },
        ...
        <div className="sidebar-logo" style={{ overflow: 'hidden' }}>
          ...
          {!collapsed && (
            <div className="min-w-0">
              ...
              <div className="sidebar-logo-sub">PHARMA + ACCOUNTS</div>
            </div>
          )}
