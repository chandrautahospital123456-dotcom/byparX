...
import { Button, Tabs, Modal, Badge, Pagination, SkeletonRows, Alert, Empty, SearchInput } from '@/components/ui'
    ...
    <div>
      ...
      {tab === 'new' && (
        <div>
          ...
          <div className="bg-[var(--surface)] border border-[var(--border)] rounded-xl p-4 mb-4 shadow-card">
            <div className="font-bold text-sm text-[var(--text)] mb-3">Purchase Items</div>
          ...
          <div className="table-card">
            <div className="overflow-x-auto">
              <table className="erp-table">
                <thead><tr><th>Bill No</th><th>Date</th><th>Supplier</th><th className="td-right">Total</th><th className="td-right">Paid</th><th className="td-right">Due</th><th>Mode</th><th>Status</th></tr></thead>
                <tbody>
                  {loading
                    ? <SkeletonRows cols={8} />
                    : purchases.length
